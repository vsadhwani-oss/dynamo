...
fn extract_assistant_content_text(
    content: &dynamo_async_openai::types::ChatCompletionRequestAssistantMessageContent,
) -> String {
    use dynamo_async_openai::types::ChatCompletionRequestAssistantMessageContent as Content;
    use dynamo_async_openai::types::ChatCompletionRequestAssistantMessageContentPart as Part;
...
fn apply_continue_final_message(
    ...
    use dynamo_async_openai::types::ChatCompletionRequestMessage as Message;
...
fn make_tokenize_chat_completion_request(
    ...
    let inner = dynamo_async_openai::types::CreateChatCompletionRequest {
        model,
